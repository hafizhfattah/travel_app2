...
class SampleMenu extends StatelessWidget {
  ...
  final orange = CupertinoColors.systemOrange;
    ...
    return FutureBuilder<WebViewController>(
      ...
      builder:
        ...
        return Row(
          children: <Widget>[
            IconButton(
              icon: const Icon(CupertinoIcons.back, color: orange),
            ...
            IconButton(
              icon: const Icon(CupertinoIcons.forward, color: orange),
              onPressed: !webViewReady
                  ? null
                  : () async {
            ...
            IconButton(
              icon: const Icon(Icons.replay, color: orange),
              onPressed: !webViewReady
                  ? null
                  : () {
                      controller!.reload();
